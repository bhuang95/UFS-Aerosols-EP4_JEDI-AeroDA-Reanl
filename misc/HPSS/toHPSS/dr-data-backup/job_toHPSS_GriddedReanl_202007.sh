...
#SBATCH --mem=10g
#SBATCH -D ./
#SBATCH -o /scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/miscLog/toHPSS_GriddedReanl_202007.txt
#SBATCH -e /scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/miscLog/toHPSS_GriddedReanl_202007.txt

module load hpss
set -x

SDATE=2022070100  #2022030100  #2021110100
#2021070100  #2021010100  #2020070200 # 2023110100  #2023070100  #2023010100
EDATE=2022093018  #2022063018  #2022022818
#2021103118  #2021063018  #2020123118 #2024011800  #2023103100  #2023063000
CINC=6
NARAOLD="NARA-2.0"
NARANEW="NARA-V1.1"
EXPNAME="AeroReanl_EP4_AeroDA_YesSPEEnKF_YesSfcanl_v15_0dz0dp_41M_C96_202007"
NODAEXPNAME="AeroReanl_EP4_FreeRun_NoSPE_YesSfcanl_v15_0dz0dp_1M_C96_202007"
