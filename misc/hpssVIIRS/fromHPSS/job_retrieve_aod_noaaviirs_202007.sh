...
#SBATCH -p service
#SBATCH -D ./
#SBATCH -o /scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/misc/retaod_202007.txt
#SBATCH -e /scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/misc/retaod_202007.txt
...
cd ${SCRIPTDIR}
/apps/slurm/default/bin/sbatch job_prepaod_noaaviirs_v1_v2_v3_202007.sh
exit ${ECNT}
