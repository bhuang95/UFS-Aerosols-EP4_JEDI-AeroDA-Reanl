...
set -x
export HOMEjedi=${HOMEjedi:-"/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes-Rockey8/JEDI/V20240115/buildIntelSpack1.6.0"}
. ${HOMEjedi}/../jedi_module_base.hera.intel.rockey8.spack-stack1.6.0.csh
module load nco
...
SDAY=2020020100 #  $(cat SDAY.info)  #2019092100
EDAY=2020022918 #$(cat EDAY.info)  #2019102200
...
CYCINTHR=${CYCINTHR:-"6"}
CASE=${CASE_OBS:-"C192"}
ROTDIR=${ROTDIR:-"/scratch1/NCEPDEV/rstprod/Bo.Huang/HpssViirsAod/completed/${PSLOT}/"}
...
echo "SUCCESSFUL" > ${SDAY}_${EDAY}.prepaod
