...
#SBATCH -q batch
#SBATCH -n 1
#SBATCH -J 2018aeronet
#SBATCH -p service
#SBATCH -t 23:59:00
#SBATCH -o /scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/MISC/tmprun/aeronet_ioda_201801.out
#SBATCH -e /scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/MISC/tmprun/aeronet_ioda_201801.out

set -x

SDATE=2020010100  #2019010100 #2018030100  #2018020100  #2020071006   #2018011006  #2017120100
EDATE=2020053118  #2019123118 #2018123118  #2018022818  #2020073118  #2018013118  #2018011000
CYCINC=6
...
DATA=/scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/MISC/tmprun-201801/aeronet_aod
