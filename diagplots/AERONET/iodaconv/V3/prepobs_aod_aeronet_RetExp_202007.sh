...
#SBATCH -q batch
#SBATCH -n 1
#SBATCH -J 2020aeronet
#SBATCH -p service
#SBATCH -t 23:59:00
#SBATCH -o /scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/MISC/tmprun/aeronet_ioda_202007.out
#SBATCH -e /scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/MISC/tmprun/aeronet_ioda_202007.out

set -x
 
SDATE=2024032200  #2024080300  #2022010100  #2021101600  #2021010100  #2020080100  #2018020100  #2020071006   #2018011006  #2017120100
EDATE=2024032500  #2024080300  #2022123118  #2021123118   #2021123118  #2020123118  #2018022818  #2020073118  #2018013118  #2018011000
CYCINC=6
...
#source /scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes-Rockey8/JEDI/V20240115/jedi_module_base.hera.sh
source /scratch2/BMC/gsienkf/Bo.Huang/expCodes/JEDI/jedi-bundle/MapTest/jedi_intel_hera_spack1.7.0.csh
status=$?
...
DATA=/scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/MISC/tmprun-202007/aeronet_aod
