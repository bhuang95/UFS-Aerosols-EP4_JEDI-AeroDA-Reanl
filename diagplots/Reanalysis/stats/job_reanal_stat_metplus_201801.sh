...
#SBATCH --output=/scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/miscLog/metplus_reanl_201801.out
...
#
SDATE=${SDATE:-"2018060100"}
EDATE=${EDATE:-"2018083118"}
INC_H=${INC_H:-"6"}
